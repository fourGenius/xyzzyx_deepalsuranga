 ...
 */
public class Jf_Exams extends javax.swing.JFrame {
  ...
  _bt_UserMain_home.setBorder(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jf_Exams.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loadFrame() {
        Jp_add_exams add_exams = new Jp_add_exams();

        if (add_exams == null) {
            add_exams = new Jp_add_exams();
