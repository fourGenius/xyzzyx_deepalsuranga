 ...
 */
public class jf_pro_version extends javax.swing.JFrame {

    /*
     * Creates new form jf_pro_version
     */
    public jf_pro_version() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/buton_blue_100x106.png"))); // NOI18N
        jButton1.setText("OK");
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 120, 84, 35));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 560, 170));

        setSize(new java.awt.Dimension(561, 164));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jf_pro_version.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jf_pro_version().setVisible(true);
            }
        });
    }
