...
public class Jf_admin_login extends javax.swing.JFrame {
  Border border=BorderFactory.createLineBorder(Color.white, 1);
    ...
    private void initComponents() {
        ...
        jLabel4.setPreferredSize(new java.awt.Dimension(192, 192));
        ...
        main_panel.add(adminLogin_emai, "card2");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Jf_admin_backend adminBackEnd = new Jf_admin_backend();
        adminBackEnd.setVisible(true);
        this.dispose();
    ...
    private void _lb_admin_login_minimizeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event__lb_admin_login_minimizeMouseClicked
        ...
        this.setState(Jf_admin_login.ICONIFIED);
